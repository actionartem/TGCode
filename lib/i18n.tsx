...
const translations: Record<Language, Translations> = {
  ru: {
      ...
      items: [
        {
          ...
          description: "быстро грузятся, красиво живут, хорошо конвертят.",
        },
        {
          title: "Корпоративные сайты",
          description: "структура, информативность, стиль — без скуки.",
        },
        {
          title: "Telegram боты",
        ...
        },
        {
          ...
          description: "кабинеты, роли, задачи, аналитика, интеграции.",
        },
        {
          title: "UI/UX + Motion",
          description: "продумываем логику и добавляем магию в детали.",
        },
        {
          title: "Интеграции и API",
          description: "свяжем всё со всем (аккуратно).",
        },
        {
          title: "Поддержка и развитие",
          description: "после релиза не исчезаем.",
        },
      ],
    },
    whyUs: {
      title: "Почему мы",
      items: [
        "Делаем эффектно, но не в ущерб смыслу.",
        "Покажем прототип рано — чтобы вы могли «пощупать» идею.",
        "Не прячем процесс: короткие апдейты, понятные решения.",
        "Любим сложные задачи. Простые — тоже любим.",
        "Если можно сделать проще — сделаем проще. Если нельзя — сделаем красиво.",
      ],
    },
    cases: {
      title: "Кейсы",
    ...
    process: {
      title: "Как работаем",
      steps: [
        { title: "01", description: "Слушаем и уточняем." },
        { title: "02", description: "Прототип: быстро показываем логику." },
        {
          title: "03",
          description: "Дизайн: подготавливаем и согласовываем стиль.",
        },
        {
          title: "04",
          description: "Разработка: аккуратно, быстро и даже потом протестим.",
        },
        {
          title: "05",
          description:
            "Запуск и улучшения: смотрим метрики, докручиваем, поддерживаем.",
        },
      ],
    },
    tech: {
