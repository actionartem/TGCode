      ...
      items: [
        {
          ...
          answer:
            "Скажите задачу - мы предложим варианты по бюджету и срокам.",
        },
        {
          question: "С чего начать?",
          answer:
            "С пары предложений о проекте. Можно без профессионального ТЗ, просто опишите как видите, разберём вместе.",
        },
        {
        ...
        },
        {
          question: "Сроки?",
          answer:
            "Зависит от объёма. Быстро показываем первую версию, а дальше идём итерациями по контрольным точкам.",
        },
      ],
    },
    contact: {
